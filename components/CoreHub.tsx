...
//     const getGroupedPatchNote = async (patchNote: PatchNote[]) => {
//         const res = await fetch("/api/corehub/patchnote", {
//             method: "GET",
//             headers: { "Content-Type": "application/json" },
//         })
...
//                         <button onClick={() => { setPaperState(1); addFeatureToState() }} className={`${paperState === 1 ? "bg-[#2a2a3d]" : ""} rounded-md px-3 py-1 text-white hover:text-white/60 transition cursor-pointer`}>Features</button>
//                         <button onClick={() => { setPaperState(2); addSuggestToState()}} className={`${paperState === 2 ? "bg-[#2a2a3d]" : ""} rounded-md px-3 py-1 text-white hover:text-white/60 transition cursor-pointer`}>Suggestions</button>
//                     </div>
//                     <div>
