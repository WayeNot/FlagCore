...
<<<<<<< HEAD
                <h2 className="text-center text-white/50 text-[35px] font-mono mt-10 mb-15">To access a room, please enter your access code :</h2>
            ...
            <div className="space-y-4 mt-5 flex flex-col gap-5 font-mono">            
                <div className="flex mx-auto gap-30">
                    <div className="flex-col items-center gap-3 text-[20px] uppercase border-2 border-white/40 tracking-[0.2em] text-white/30">
                        <h2 className="flex items-center gap-6 mx-50 p-2 font-bold"><VscCircleLargeFilled size={15} className="text-green-400" />Active Rooms</h2>
                        <div className="border-t-2"></div>
                        <p>test</p>
                    </div>
                    <div className="flex-col items-cente gap-3 text-[20px] uppercase border-2 border-white/40 tracking-[0.2em] text-white/30">
                        <h2 className="flex items-center gap-6 mx-50 p-2 font-bold"><VscCircleLargeFilled size={15} className="text-red-400" />Old Rooms</h2>
                        <div className="border-t-2"></div>
                        <p>test</p>
                    </div>
                </div>
